...
var firstArray = _.map(hwArray, 'skills');
firstArray = _.flattenDeep(firstArray);
firstArray = _.uniq(firstArray);
firstArray = _.map(firstArray, function (elem) {
	return elem.toUpperCase();
});
firstArray = _.sortBy(firstArray);



var secondArray = _.sortBy(hwArray, function(coll) {
	return _.size(coll.friends);
});
secondArray = _.map(secondArray, 'name')



var thirdArray = _.map(hwArray, 'friends');
thirdArray = _.flattenDeep(thirdArray);
thirdArray = _.map(thirdArray, 'name');
thirdArray = _.sortBy(thirdArray);
thirdArray = _.uniq(thirdArray);
